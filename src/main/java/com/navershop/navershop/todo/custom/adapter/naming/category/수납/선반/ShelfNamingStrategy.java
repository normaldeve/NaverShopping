package com.navershop.navershop.todo.custom.adapter.naming.category.수납.선반;
...
@Slf4j
@Component
public class ShelfNamingStrategy implements ProductNamingStrategy {
    ...
    public boolean supports(String categoryName) {
        return categoryName != null && categoryName.contains("선반");
    }
